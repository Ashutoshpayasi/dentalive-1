...
<head>
	...
	<body>
		...
		<div id="page" class="page">
			 	...
			 	<div class="headtoppart bg-blue clearfix">
			  	...
			  	<div class="wsmainfull menu clearfix">
    				<div class="wsmainwp clearfix">
    					...
    					<div class="desktoplogo"><a href="#hero-2"><img src="images/logo.png"  width="180" height="40" alt="header-logo"></a></div>
		       						...
		       						<div class="row">
		       							<div class="col-md-9 col-lg-7">
		       								<div class="caption-txt">
												...
												<div class="box-list">	
													<div class="box-list-icon blue-color"><i class="fas fa-angle-double-right"></i></div>
													<p class="p-md">Feugiat primis ultrice in ligula risus auctor tempus feugiat impedit</p>		
												</div>
												...
												<div class="box-list mb-15">	
													...
													<p class="p-md">Porta semper lacus cursus, feugiat primis ultrice in ligula risus 
													   auctor tempus feugiat dolor impedit magna purus at pretium donec
													</p>		
												</div>
		       							...
		       							<div class="col-md-9 col-lg-7 offset-md-3 offset-lg-5">
		       								<div class="caption-txt">
												...
												<p class="p-md">Feugiat primis ligula risus auctor egestas augue mauri viverra tortor 
												   ...
												   and lorem primis in integer mollis pretium purus pretium ligula
												</p>

												<!-- Button -->
												<a href="all-departments.php" class="btn btn-blue blue-hover">Our Departments</a>
						...
						<div class="col-lg-4">
							<div class="abox-4 mb-40 wow fadeInUp" data-wow-delay="0.4s">
								...
								<div class="abox-4-txt">
									...
									<!-- Title -->
									<h5 class="h5-xs steelblue-color"><a href="all-services.php">Highest Quality Care</a></h5>
						...
						<div class="col-lg-4">
							<div class="abox-4 mb-40 wow fadeInUp" data-wow-delay="0.6s">
								...
								<div class="abox-4-txt">
									...
									<!-- Title -->
									<h5 class="h5-xs steelblue-color"><a href="all-services.php">Emergency Department</a></h5>
			...
			<!-- INFO-3
			============================================= -->
			<section id="info-3" class="bg-blue info-section division">
				<div class="container">
				 	<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="info-3-img text-center">
								<img class="img-fluid" src="images/medical_complex_700x700.jpg" alt="info-image" />
					 		</div>
						</div>
					 	...
					 	<div class="col-lg-6">
					 		<div class="txt-block pc-30 white-color wow fadeInUp" data-wow-delay="0.4s">
								...
								<p>An enim nullam tempor sapien gravida donec pretium ipsum  porta justo integer at  odio
								   ...
								   a augue suscipit. Augue egestas volutpat egestas augue in cubilia laoreet magna
								</p>

								<!-- Button -->
								<a href="all-services.php" class="btn btn-tra-white white-hover mt-20">Find Out More</a>
