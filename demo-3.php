			 	...
			 	<div class="headtoppart bg-steelblue clearfix">
			  	...
			  	<div class="wsmainfull menu clearfix">
    				<div class="wsmainwp clearfix">
    					...
    					<div class="desktoplogo"><a href="#hero-3"><img src="images/logo-grey.png"  width="180" height="40" alt="header-logo"></a></div>
		       							...
		       							<div class="col-sm-10 col-md-7 col-lg-6">
		       								<div class="caption-txt">
												...
												<p class="p-md">Feugiat primis ligula risus auctor egestas augue mauri viverra
												   tortor in iaculis and placerat purus feugiat primis ultrice in ligula impedit 
												   magna purus at pretium
												</p>

												<!-- Button -->
												<a href="about-us.php" class="btn btn-md btn-blue blue-hover">More About Clinic</a>
		       								...
		       								<div class="caption-txt">
												...
												<div class="box-list">							
													...
													<p class="p-md">Quaerat sodales sapien undo euismod risus auctor egestas 
													   augue mauri viverra tortor sapien
													</p>							
												</div>
		       								...
		       								<div class="caption-txt">
												...
												<div class="box-list">							
													...
													<p class="p-md">Fringilla risus nec, luctus mauris orci auctor purus euismod 
													   pretium purus pretium ligula rutrum tempor 
													</p>						
												</div>
												...
												<div class="box-list">							
													<div class="box-list-icon blue-color"><i class="fas fa-angle-double-right"></i></div>
													<p class="p-md">Luctus mauris orci auctor purus euismod pretium purus
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="info-4-img mb-40 text-center wow fadeInUp" data-wow-delay="0.6s">
								<img class="img-fluid" src="images/pediatrics_700x800.jpg" alt="info-image">
							</div>
						</div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-7">
							<div class="banner-3-img">
								<img class="img-fluid" src="images/image-06.png" alt="banner-image" />
							</div>
						</div>
