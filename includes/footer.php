		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-4">
				<div class="footer-info mb-40">
					...
					<img src="images\logo\IMG-20231226-WA0045.png" width="170" height="70" alt="footer-logo">

					<!-- Text -->
					<p class="p-sm mt-20">Everybody loses a tooth at some point. But, 
						a smart person replaces it & continues to enjoy life!
					</p>
			...
			<div class="col-md-6 col-lg-3 offset-lg-1">
				<div class="footer-box mb-40">
					...
					<!-- Title -->
					<h5 class="h5-xs">Visit Us</h5>

					<!-- Address -->
					<p>Meghna, Shop no. 2,<br>Plot No - 95, Sec-27, Nerul,
					</p>
