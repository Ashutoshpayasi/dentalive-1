			 	...
			 	<div class="headtoppart bg-blue clearfix">
			  	...
			  	<div class="wsmainfull menu clearfix">
    				<div class="wsmainwp clearfix">
    					...
    					<div class="desktoplogo"><a href="#hero-6"><img src="images/logo-grey.png"  width="180" height="40" alt="header-logo"></a></div>
		       						...
		       						<div class="row">
		       							<div class="col-md-12">
		       								<div class="caption-txt white-color">
												...
												<!-- Button -->
												<a href="about-us.php" class="btn btn-blue tra-white-hover">More About Clinic</a>
		       						...
		       						<div class="row">
		       							<div class="col-md-12">
		       								<div class="caption-txt white-color">
												...
												<!-- Button -->
												<a href="who-we-are.php" class="btn btn-tra-white black-hover mr-10">Get More Info</a>
		       						...
		       						<div class="row">
		       							<div class="col-md-12">
				                               ...
				                               <!-- Text -->
												...
												<!-- Button -->
												<a href="all-doctors.php" class="btn btn-blue blue-hover mr-10">View All Doctors</a>
												<a href="timetable.php" class="btn btn-tra-white black-hover">Doctors Timetable</a>
						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-lg-4">
								<div class="abox-3 wow fadeInUp" data-wow-delay="0.8s">
									...
									<!-- Title -->
									<h5 class="h5-xs">Emergency Department</h5>
							...
							<div class="owl-carousel owl-theme services-holder">
								...
								<div class="sbox-5">
									...
									<div class="sbox-5-txt">
										...
										<!-- Title -->
										<h5 class="h5-sm blue-color">Pediatrics</h5>
								...
								<div class="sbox-5">
									...
									<div class="sbox-5-txt">
										...
										<!-- Title -->
										<h5 class="h5-sm blue-color">Haematology</h5>
								...
								<div class="sbox-5">
									...
									<div class="sbox-5-txt">
										...
										<!-- Title -->
										<h5 class="h5-sm blue-color">MRI Diagnostics</h5>
								...
								<div class="sbox-5">
									...
									<!-- Image -->
									<img class="img-fluid" src="images/laboratory_700x700.jpg" alt="content-image" />	
									...
									<div class="sbox-5-txt">
										...
										<!-- Title -->
										<h5 class="h5-sm blue-color">Laboratory Services</h5>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="txt-block pc-30 mb-40 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Section ID -->	
					 			<span class="section-id blue-color">Professional Care</span>
			 		...
			 		<div class="row d-flex align-items-center">
						...
						<div class="col-lg-3 ">
							<div class="banner-btn text-right">
								<a href="contacts-1.php" class="btn btn-md btn-tra-white blue-hover">Get In Touch</a>
							</div>
						</div>	
