							...
							<div class=" breadcrumb-holder">
								...
								<nav aria-label="breadcrumb">
								  	<ol class="breadcrumb">
								    	...
								    	<li class="breadcrumb-item"><a href="all-doctors.php">Our Doctors</a></li>
								    	<li class="breadcrumb-item active" aria-current="page">Doctor Page</li>
								  	</ol>
								</nav>

								<!-- Title -->
								<h4 class="h4-sm steelblue-color">Doctor Profile</h4>
					...
					<div class="row">
						...
						<div class="col-md-5 col-xl-5">
			 				<div class="doctor-photo mb-30 text-center">
								...
								<!-- Button -->
								<a href="timetable.php" class="btn btn-md btn-tra-grey grey-hover">View Timetable</a>
