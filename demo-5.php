			 	...
			 	<div class="headtoppart bg-blue clearfix">
			  	...
			  	<div class="wsmainfull menu clearfix">
    				<div class="wsmainwp clearfix">
    					...
    					<div class="desktoplogo"><a href="#hero-5"><img src="images/logo.png"  width="180" height="40" alt="header-logo"></a></div>
				...
				<div class="container">						
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-9 col-lg-7 col-xl-6">
							...
							<div class="hero-5-strip bg-blue white-color">
							...
							<div class="hero-txt">
								...
								<!-- Title -->
								<h4 class="steelblue-color">Best Quality</h4>
								<h3 class="steelblue-color">Medical treatment for your and your family</h3>

								<!-- CONTENT BOX #1 -->
								<div class="box-list grey-color">							
								...
								<!-- CONTENT BOX #3 -->
								<div class="box-list grey-color mb-15">	
									<div class="box-list-icon"><i class="fas fa-genderless"></i></div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="pricing-img wow fadeInUp" data-wow-delay="0.6s">
								<img class="img-fluid" src="images/image-04.png" alt="pricing-image">
							</div>							
						</div>
						...
						<!-- CONTACT FORM -->	
				 		<div class="col-md-7 col-lg-8">
				 			<div class="form-holder mb-40">
				 				<form name="contactForm" id="contact-form" class="row contact-form" method="post" action="https://jthemes.net/themes/html/medservices/files/php/contactForm.php">
