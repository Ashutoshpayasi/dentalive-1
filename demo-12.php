			 	...
			 	<div class="headtoppart bg-lightgrey clearfix">
			  	...
			  	<div class="wsmainfull menu clearfix">
    				<div class="wsmainwp clearfix">
    					...
    					<div class="desktoplogo"><a href="#hero-12"><img src="images/logo.png"  width="180" height="40" alt="header-logo"></a></div>
					...
					<div class="row">
						<div class="col-md-7 col-lg-7">
							<div class="hero-txt white-color">							
								...
								<h2>We Will help you to <span>become healthy</span></h2>

								<!-- CONTENT BOX #1 -->
								<div class="box-list">							
									<div class="box-list-icon"><i class="fas fa-genderless"></i></div>
									<p class="p-md">Fringilla risus nec, luctus mauris orci auctor purus euismod pretium 
									   purus undo ligula rutrum tempor sapien pretium
									</p>							
								</div>
								...
								<div class="box-list mb-15">	
									...
									<p class="p-md">Nemo ipsam egestas volute turpis dolores ut aliquam quaerat sodales 
									   sapien undo pretium purus and feugiat
									</p>				
								</div>	

								<!-- Button -->
								<a href="about-us.php" class="btn btn-tra-white blue-hover">Discover More</a>	
						...
						<div class="row">
							...
							<div class="col-md-6 col-lg-4">
								<div class="abox-2">
									...
									<!-- Button -->
									<a href="timetable.php" class="btn btn-sm btn-blue blue-hover mt-25">View Timetable</a>
