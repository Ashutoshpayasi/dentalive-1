                ...
                <div class="row">
                    <div class="col">
                        <div class=" breadcrumb-holder">
                            ...
                            <!-- Title -->
                            <h1 class="h2-sm steelblue-color">Routine Dental</h1>
                ...
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        <div class="s1-page content-block text-center">
                            ...
                            <!-- Title -->
                            <h3 class="h3-xl blue-color">Why need for Routine Dental Services</h3>
                            <!-- <h4 class="h4-md blue-color">Maecenas gravida porttitor nunc, magna luctus tempor viverra</h4> -->

                            <!-- Text -->
                            <p class="p-lg">
                                Routine dental services, often encompassing checkups and cleanings twice a year, are more than just keeping your teeth pearly white.
                                They're the cornerstone of good oral health and a gateway to overall well-being.</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-block-img text-center">
                            <img class="img-fluid" src="images\Dentalive-images\dental-searching-round-concept_98292-7423.jpg" alt="content-image">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        <div class="s1-page content-block text-center mb-40">
                            ...
                            <!-- Text -->
                            <p class="p-lg"> Routine dental services, including regular check-ups and cleanings, play a crucial role in preventing dental issues. Early detection of problems allows for
                                timely intervention and prevents more extensive treatments.
                            </p>

                            <!-- Text -->
                            <p class="p-lg"> Consistent dental care helps maintain optimal oral health. Regular cleanings remove plaque and tartar,
                                reducing the risk of cavities, gum disease, and other oral conditions.
                            </p>
