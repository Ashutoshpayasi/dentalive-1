...
<head>
	...
	<body>
		...
		<div id="page" class="page">
			 	...
			 	<div class="headtoppart bg-lime clearfix">
			  	...
			  	<div class="wsmainfull menu clearfix">
    				<div class="wsmainwp clearfix">
    					...
    					<div class="desktoplogo"><a href="#hero-8"><img src="images/logo-grey.png"  width="180" height="40" alt="header-logo"></a></div>
    					...
    					<!-- MAIN MENU -->
      					<nav class="wsmenu clearfix">
        					<ul class="wsmenu-list">
							    ...
							    <li class="nl-simple header-btn lime-btn" aria-haspopup="true"><a href="appointment.php">Make an Appointment</a></li>
			    	...
			    	<ul class="slides">
				     	...
				     	<!-- SLIDE #1 -->
				      	<li id="slide-1">
					        ...
					        <!-- Background Image -->
				        	<img src="images/slider/slide-14.jpg" alt="slide-background">
		       						...
		       						<div class="row">
		       							<div class="col-sm-9 col-md-8 col-lg-7">
		       								<div class="caption-txt">
												...
												<!-- Button -->
												<a href="about-us.php" class="btn btn-lime black-hover">More About Clinic</a>
				      	...
				      	<li id="slide-2">
				        	...
				        	<!-- Background Image -->
				        	<img src="images/slider/slide-15.jpg" alt="slide-background">
		       						...
		       						<div class="row">
		       							<div class="col-sm-9 col-md-8 col-lg-7 offset-sm-3 offset-md-4 offset-lg-5">
		       								<div class="caption-txt">
												...
												<!-- Button -->
												<a href="all-services.php" class="btn btn-lime black-hover">Our Core Services</a>
				     	...
				     	<!-- SLIDE #3 -->
				      	<li id="slide-3">
				      		...
				      		<!-- Background Image -->
				        	<img src="images/slider/slide-16.jpg" alt="slide-background">
		       						...
		       						<div class="row">
		       							<div class="col-sm-9 col-md-8 col-lg-7">
		       								<div class="caption-txt">
												...
												<!-- Button -->
												<a href="all-doctors.php" class="btn btn-lime black-hover">Meet the Doctors</a>
			 		...
			 		<div class="row">
						...
						<div class="col-md-6 col-lg-3">
							<div class="sbox-4 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/breast_procedure_700x800.jpg" alt="content-image" />	
									
								<!-- Text -->
								<div class="sbox-4-txt">
									<h5 class="h5-md lime-color"><a href="service-1.php">Breast Procedures</a></h5>
						...
						<div class="col-md-6 col-lg-3">
							<div class="sbox-4 wow fadeInUp" data-wow-delay="0.6s">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/body_procedure_700x800.jpg" alt="content-image" />	
									
								<!-- Text -->
								<div class="sbox-4-txt">
									<h5 class="h5-md lime-color"><a href="service-1.php">Body Procedures</a></h5>
									<p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
									   at pretium feugiat dolor integer
									</p>
								</div>								
						...
						<div class="col-md-6 col-lg-3">
							<div class="sbox-4 wow fadeInUp" data-wow-delay="0.8s">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/face_procedure_700x800.jpg" alt="content-image" />	
									
								<!-- Text -->
								<div class="sbox-4-txt">
									<h5 class="h5-md lime-color"><a href="service-1.php">Face Procedures</a></h5>
									<p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
									   at pretium feugiat dolor integer
									</p>
								</div>
						...
						<div class="col-md-6 col-lg-3">
							<div class="sbox-4 wow fadeInUp" data-wow-delay="1s">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/rec_procedure_700x800.jpg" alt="content-image" />	
									
								<!-- Text -->
								<div class="sbox-4-txt">
									<h5 class="h5-md lime-color"><a href="service-1.php">Reconstructive</a></h5>
									<p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
									   at pretium feugiat dolor integer
									</p>
								</div>				
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="info-2-img wow fadeInUp" data-wow-delay="0.6s">
								<img class="img-fluid" src="images/image-10.png" alt="info-image">
							</div>
						</div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-8 col-lg-7 col-xl-6 offset-md-4 offset-lg-5 offset-xl-6">
							<div class="txt-block pc-30 white-color">
								...
								<!-- Button -->
								<a href="all-doctors.php" class="btn btn-tra-white blue-hover mt-25">Meet The Doctors</a>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="all-doctors mb-40">
								<a href="all-doctors.php" class="btn btn-lime black-hover">Meet All Doctors</a>
							</div>
						</div>
					</div>
			 			...
			 			<div class="col-lg-6">
			 				<div class="video-preview mb-40 text-center wow fadeInUp" data-wow-delay="0.6s">
								...
								<a class="video-popup1" href="https://www.youtube.com/embed/SZEflIVnhH8">
									...
									<!-- Preview -->	
									<img class="img-fluid" src="images/video-3.png" alt="video-photo" />
			...
			<!-- BANNER-7
			============================================= -->
			<section id="banner-7" class="bg-fixed banner-section division" style="background-image: url(images/bg-beauty.jpg);">
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="all-posts-btn mb-40 wow fadeInUp" data-wow-delay="1s">
								<a href="blog-listing.php" class="btn btn-lime black-hover">Read More Posts</a>
							</div>
						</div>
					</div>
