			 		...
			 		<div class="container">
			 			<div class="row d-flex align-items-center">
		    				...
		    				<div class="col-md-5 col-xl-6">
		    					<div class="desktoplogo"><a href="#hero-9"><img src="images/logo.png"  width="180" height="40" alt="header-logo"></a></div>
		    				</div>
						    	...
						    	<div class="row">
						    		...
						    		<div class="col-md-6">
						    			<div class="header-widget icon-xs">
							    			...
							    			<div class="header-widget-txt">
								    			<p class="txt-400">Mon – Fri : - 8:00 AM - 8:00 PM</p>
								    			<p class="lightgrey-color">Sat - Sun : - Closed</p>
								    		</div>
						    			</div>
						    		</div>
			  	...
			  	<div class="wsmainfull menu clearfix">
    				<div class="wsmainwp clearfix">
    					...
    					<!-- MAIN MENU -->
      					<nav class="wsmenu clearfix">
        					<ul class="wsmenu-list">
								                ...
								                <div class="col-lg-4 col-md-12 col-xs-12">
                    								...
                    								<ul class="latest-news">
														...
														<li class="clearfix d-flex align-items-center">
															...
															<!-- Image -->
															<img class="img-fluid" src="images/blog/header-post-1.php" alt="blog-post-preview" />
														...
														<li class="clearfix d-flex align-items-center">
															...
															<!-- Image -->
															<img class="img-fluid" src="images/blog/header-post-2.php" alt="blog-post-preview" />
														...
														<li class="clearfix d-flex align-items-center">
															...
															<!-- Image -->
															<img class="img-fluid" src="images/blog/header-post-3.php" alt="blog-post-preview" />
							    ...
							    <li class="nl-simple header-btn" aria-haspopup="true"><a class="blue-hover" href="timetable.php">Our Doctors Timetable</a></li> 
        				...
        				<div class="header-button">
        					<span class="nl-simple header-btn blue-hover"><a href="timetable.php">Our Doctors Timetable</a></span>
        				</div>
						          		...
						          		<!-- SLIDE-1 TEXT -->
						           		<div class="col-md-8 col-lg-7">
						           			<div class="hero-txt">
												...
												<!-- Button -->
												<a href="about-us.php" class="btn btn-blue blue-hover">More About Clinic</a>
						          		...
						          		<!-- SLIDE-2 TEXT -->
						           		<div class="col-md-8 col-lg-7 offset-md-4 offset-lg-5">
						           			<div class="hero-txt">
												...
												<!-- Button -->
												<a href="who-we-are.php" class="btn btn-black tra-black-hover mr-10">Get More Info</a>
												<a href="all-services.php" class="btn btn-blue blue-hover">Our Core Services</a>
						...
						<div class="col-lg-6">
							<div class="txt-block pc-30 mb-40 wow fadeInUp" data-wow-delay="0.4s">
								...
								<p class="mb-30">An enim nullam tempor sapien gravida donec enim ipsum blandit
								   ...
								   purus pretium ligula rutrum itae laoreet augue undo cubilia laoreet an augue 
					...
					<div class="row d-flex align-items-center">	
						<div class="col-lg-6 offset-lg-6">
							<div class="txt-block pc-30 white-color wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Title -->
								<h3 class="h3-md">Clinic with Innovative Approach to Treatment</h3>							
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Button -->
								<a href="all-doctors.php" class="btn btn-blue blue-hover mt-25">Meet The Doctors</a>
						...
						<div class="col-lg-6">
							<div class="about-img text-center wow fadeInUp" data-wow-delay="0.6s">
								<img class="img-fluid" src="images/image-09.png" alt="about-image">
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="all-posts-btn mb-40 wow fadeInUp" data-wow-delay="1s">
								<a href="blog-listing.php" class="btn btn-blue blue-hover">Read More Posts</a>
							</div>
						</div>
					</div>
					...
					<div class="row ">
					 	<div class="col-lg-6 offset-lg-6">
					 		<div class="banner-txt">
							    ...
							    <h3 class="h3-xl blue-color">+1-800-123-4560</h3>

							    <!-- Text -->
								<p>Egestas magna egestas magna ipsum vitae purus ipsum primis in cubilia laoreet augue
								   egestas suscipit lectus mauris lectus laoreet gestas neque undo luctus feugiat a augue
								   suscipit luctus
							    </p>

								<!-- Button -->
								<a href="#" class="btn btn-blue blue-hover mt-20">Make An Apointment</a>
