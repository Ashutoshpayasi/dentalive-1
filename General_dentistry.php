                ...
                <div class="row">
                    <div class="col">
                        <div class=" breadcrumb-holder">
                            ...
                            <!-- Title -->
                            <h1 class="h2-sm steelblue-color">General Dentistry</h1>
                ...
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        <div class="s1-page content-block text-center">
                            ...
                            <!-- Title -->
                            <h3 class="h3-xl blue-color">Why need for General Dentistry Services</h3>
                            <!-- <h4 class="h4-md blue-color">Maecenas gravida porttitor nunc, magna luctus tempor viverra</h4> -->

                            <!-- Text -->
                            <p class="p-lg">At Dentalive, we believe that everyone deserves a healthy, confident smile. That's why we offer a comprehensive range of
                                general dentistry services tailored to your individual needs and preferences.</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-block-img text-center">
                            <img class="img-fluid" src="images\Dentalive-images\dentist-doing-check-up-patient_23-2149206225.jpg" alt="content-image">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        <div class="s1-page content-block text-center mb-40">
                            ...
                            <!-- Text -->
                            <p class="p-lg">General dentistry, also known as family dentistry, is a branch of dentistry that focuses on the overall oral health and hygiene of patients. General dentists are primary care providers
                                for dental health and are trained to handle a wide range of dental issues.
                            </p>

                            <!-- Text -->
                            <p class="p-lg">Our patient-centered approach puts you at the heart of everything we do. We prioritize open communication, understanding your concerns,
                                and working together to create a treatment plan that fits your goals and budget.
                            </p>
