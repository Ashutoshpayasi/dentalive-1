			 		...
			 		<div class="container">
			 			<div class="row d-flex align-items-center">
		    				...
		    				<div class="col-md-5 col-xl-6">
		    					<div class="desktoplogo"><a href="#hero-4"><img src="images/logo.png"  width="180" height="40" alt="header-logo"></a></div>
		    				</div>
							...
							<div class="hero-txt mb-40">
								...
								<div class="box-list">							
									...
									<p>Fringilla risus nec, luctus mauris orci auctor purus euismod pretium purus at pretium
									   ligula rutrum tempor sapien at pretium luctus ligula luctus risus
									</p>							
								</div>
								...
								<div class="box-list">							
									<div class="box-list-icon"><i class="fas fa-genderless"></i></div>
									<p>Quaerat sodales sapien undo euismod purus a blandit pretium ultrice</p>							
								</div>
								...
								<div class="box-list">	
									...
									<p>Nemo ipsam egestas volute turpis dolores ut aliquam quaerat sodales sapien undo pretium
									   purus feugiat dolor impedit magna purus pretium
									</p>				
								</div>
							...
							<div id="hero-section-form" class="text-center mb-40">
								<form name="heroForm" class="row hero-form bg-blue">
                                    ...
                                    <div class="col-md-12 white-color">
                                        <h4 class="h4-xs">Get an Appointment</h4>	
                                    </div> 
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Title -->
								<h3 class="h3-md steelblue-color">MedService is the Best Health Care Website</h3>
								...
								<!-- Button -->
								<a href="who-we-are.php" class="btn btn-blue blue-hover mt-25">Who We Are</a>
