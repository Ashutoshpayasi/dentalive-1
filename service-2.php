					...
					<div class="row">						
						<div class="col">
							<div class=" breadcrumb-holder">
								...
								<!-- Title -->
								<h4 class="h4-sm steelblue-color">Service Single #2</h4>
						...
						<!-- SERVICE CONTENT -->
				 		<div class="col-lg-8">
				 			<div class="s2-page pr-30 mb-40">
								...
								<!-- Button -->
								<a href="appointment.php" class="btn btn-blue blue-hover">Book an Appointment</a>
