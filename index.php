...
<body>
								...
								<div class="col-sm-9 col-md-8 col-lg-7 col-xl-6">
									<div class="caption-txt">
										...
										<!-- <div class="box-list">
											...
											<p class="p-md">Explore the difference of Dentalive Services. Our commitment is to provide top-notch dental care that goes beyond expectations.
												Join us in creating a healthier and more confident you.
											</p>
										</div> -->
								...
								<div class="col-sm-9 col-md-8 col-lg-7 col-xl-6">
									<div class="caption-txt">
										...
										<div class="box-list">
											...
											<p class="p-md">Discover the benefits of straighter teeth. Our expert team focuses on creating beautiful and healthy smiles.
											</p>
										</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1 section-title">
					...
					<!-- Title 	-->
					<h3 class="h3-md steelblue-color">We Create the Healthy Smiles</h3>

					<!-- Text -->
					<p>Transforming smiles with care and expertise.
						Our dedicated team is committed to providing exceptional dental services.
					</p>
	...
	<section class="bg-lightgrey pt-20 about-section division">
		<div class="container">
			<div class="row d-flex align-items-center">
