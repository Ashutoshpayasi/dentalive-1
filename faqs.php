									...
									<div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
										<div class="card-body">
											...
											<p>Nullam rutrum eget nunc varius etiam mollis risus congue aliquam etiam sapien egestas,
												...
												auctor eros dolor luctus odio tempor sapien gravida donec pretium and ipsum porta
											</p>
									...
									<div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
										<div class="card-body">
											...
											<p>Maecenas gravida porttitor nunc, quis vehicula magna luctus tempor. Quisque vel
												...
												consectetur nibh, imperdiet cubilia curae integer congue leo metus, primis in orci
												integer metus mollis faucibus enim
											</p>
									...
									<div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
										<div class="card-body">
											...
											<p>Nullam rutrum eget nunc varius etiam mollis risus congue aliquam etiam sapien
												egestas, congue gestas posuere cubilia congue ipsum
											</p>
											...
											<ul class="content-list">
												...
												<li>
													<p>Vitae auctor integer congue magna at pretium purus pretium ligula rutrum luctus
														risus eros dolor auctor cubilia curae integer congue leo metus, primis in orci
														integer metus mollis enim
													</p>
												</li>

												<li>
													<p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas magna
														cubilia curae integer congue leo metus, primis in orci integer metus mollis
														faucibus enimipsum
													</p>
												</li>
									...
									<div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingFour" data-parent="#accordion">
										<div class="card-body">
											...
											<p>Aliqum mullam blandit tempor sapien gravida donec ipsum, at porta justo. Velna
												...
												magnis sapien etiam sapien sem sagittis cubilia curae integer congue leo metus,
												primis in orci integer metus mollis enim
											</p>
									...
									<div id="collapseFive" class="collapse" role="tabpanel" aria-labelledby="headingFive" data-parent="#accordion">
										<div class="card-body">
											...
											<p>Nullam non scelerisque lectus. In at mauris vel nisl convallis porta at vitae dui. Nam
												lacus ligula, vulputate molestie quis aliquet cubilia curae integer congue leo metus, primis
												in orci integer metus mollis faucibus enim
											</p>
									...
									<div class="card-header" role="tab" id="headingEight">
										<h5 class="h5-xs">
											<a class="collapsed" data-toggle="collapse" href="#collapseEight" role="button" aria-expanded="false" aria-controls="collapseEight">
												Can I auctor eros dolor luctus odio placerat massa magna?
											</a>
										</h5>
									</div>
									...
									<div id="collapseEight" class="collapse" role="tabpanel" aria-labelledby="headingEight" data-parent="#accordion">
										<div class="card-body">
											...
											<p>Maecenas gravida porttitor nunc, quis vehicula magna luctus tempor. Quisque vel laoreet turpis. Urna
												...
												viverra. Pellentesque ac massa lorem. Fusce eu cursus est fusce non nulla
											</p>
									...
									<div id="collapseNine" class="collapse" role="tabpanel" aria-labelledby="headingNine" data-parent="#accordion">
										<div class="card-body">
											...
											<ul class="content-list">
												...
												<li>
													<p>Vitae auctor integer congue magna at pretium purus pretium ligula rutrum luctus risus</p>
												</li>

												<li>
													<p>Sagittis congue augue egestas volutpat egestas magna suscipit egestas magna
														ipsum vitae purus efficitur ipsum primis in cubilia laoreet augue egestas
														luctus donec diamTempor sapien gravida donec enim ipsum blandit magna at
														purus pretium ligula rutrum luctus
													</p>
												</li>

												<li>
													<p>Justo odio integer a velna lectus aenean magna and mauris lectus pretium
														ligula rutrum luctus risus ac risus auctor gravida donec congue tempor gravida
								...
								<div class="card">
									...
									<div id="collapseEleven" class="collapse" role="tabpanel" aria-labelledby="headingEleven" data-parent="#accordion">
										<div class="card-body">
											...
											<!-- Text -->
											<p>Curabitur ac dapibus libero. Quisque eu tristique neque. Phasellus blandit tristique
												justo ut aliquam. Aliquam vitae molestie nunc. Quisque sapien justo, aliquet non molestie
												sed, venenatis nec purus. Aliquam eget lacinia elit. Vestibulum tincidunt tincidunt massa,
												et porttitor justo tincidunt eu.
											</p>
