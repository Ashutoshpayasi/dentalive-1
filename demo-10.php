...
<head>
	...
	<body>
			...
			<div class="blockChanger bgChanger">
                ...
                <div class="chBody">														
					<div class="stBlock text-center" style="margin:30px 20px 30px 16px">
						<p>Choose Layout</p>
						<a class="s_1" href="demo-1.php"><img src="images/color-scheme/l-01.jpg" width="175" height="120" alt="layout-image"></a>
						<a class="s_1" href="demo-2.php"><img src="images/color-scheme/l-02.jpg" width="175" height="93" alt="layout-image"></a>
						<a class="s_1" href="demo-3.php"><img src="images/color-scheme/l-03.jpg" width="175" height="105" alt="layout-image"></a>
						<a class="s_1" href="demo-4.php"><img src="images/color-scheme/l-04.jpg" width="175" height="100" alt="layout-image"></a>
						<a class="s_1" href="demo-5.php"><img src="images/color-scheme/l-05.jpg" width="175" height="112" alt="layout-image"></a>
						<a class="s_1" href="demo-6.php"><img src="images/color-scheme/l-06.jpg" width="175" height="100" alt="layout-image"></a>
						<a class="s_1" href="demo-7.php"><img src="images/color-scheme/l-07.jpg" width="175" height="97" alt="layout-image"></a>
						<a class="s_1" href="demo-8.php"><img src="images/color-scheme/l-08.jpg" width="175" height="91" alt="layout-image"></a>
						<a class="s_1" href="demo-9.php"><img src="images/color-scheme/l-09.jpg" width="175" height="97" alt="layout-image"></a>
						<a class="s_1" href="demo-10.php"><img src="images/color-scheme/l-10.jpg" width="175" height="105" alt="layout-image"></a>
						<a class="s_1" href="demo-11.php"><img src="images/color-scheme/l-11.jpg" width="175" height="105" alt="layout-image"></a>
						<a class="s_1" href="demo-12.php"><img src="images/color-scheme/l-12.jpg" width="175" height="125" alt="layout-image"></a>
					</div>						
				</div>
			</div>
		</div>	  <!-- END SWITCHER -->
		...
		<div id="page" class="page">
			 	...
			 	<div class="headtoppart bg-steelblue clearfix">
			  	...
			  	<div class="wsmainfull menu clearfix">
    				<div class="wsmainwp clearfix">
    					...
    					<div class="desktoplogo"><a href="#hero-10"><img src="images/logo-grey.png"  width="180" height="40" alt="header-logo"></a></div>
        					...
        					<ul class="wsmenu-list">
					        	...
					        	<li aria-haspopup="true"><a href="#">Home <span class="wsarrow"></span></a>
					           		<ul class="sub-menu">
					              		...
					              		<li aria-haspopup="true"><a href="demo-7.php">Home Concept #7</a></li>
                    								...
                    								<ul class="latest-news">
														...
														<li class="clearfix d-flex align-items-center">
															...
															<div class="post-summary">
																<a href="single-post.php">Etiam sapien risus ante auctor tempus accumsan an empor ...</a>
																<p>43 Comments</p>
															</div>
														...
														<li class="clearfix d-flex align-items-center">
															...
															<!-- Text -->
															<div class="post-summary">
																<a href="single-post.php">Blandit tempor a sapien ipsum, porta risus auctor justo ...</a>
																<p>38 Comments</p>
															</div>
														...
														<li class="clearfix d-flex align-items-center">
															...
															<!-- Text -->
															<div class="post-summary">
																<a href="single-post.php">Cursus risus auctor tempus risus laoreet turpis auctor varius ...</a>
																<p>29 Comments</p>
															</div>
							    ...
							    <li class="nl-simple header-btn" aria-haspopup="true"><a href="appointment.php">Make an Appointment</a></li>
			...
			<!-- HERO-10
			============================================= -->	
			<section id="hero-10" class="hero-section division">
			    	...
			    	<ul class="slides">
				     	...
				     	<!-- SLIDE #1 -->
				      	<li id="slide-1">
					        ...
					        <!-- Background Image -->
				        	<img src="images/slider/slide-17.jpg" alt="slide-background">
		       						...
		       						<div class="row">
		       							<div class="col-sm-9 col-md-7 col-lg-6 offset-sm-3 offset-md-5 offset-lg-6">
		       								<div class="caption-txt">
						       					...
						       					<!-- Title -->
						       					<h2 class="steelblue-color">Bring world into focus</h2>

						       					<!-- Text -->
												<p class="p-md">Feugiat primis ligula risus auctor egestas augue mauri viverra tortor 
												   in iaculis placerat eugiat mauris ipsum at viverra tortor and gravida purus pretium 
												   auctor lorem primis mollis
												</p>

												<!-- Button -->
												<a href="who-we-are.php" class="btn btn-blue tra-black-hover">Get More Info</a>       
				      	...
				      	<li id="slide-2">
				        	...
				        	<!-- Background Image -->
				        	<img src="images/slider/slide-18.jpg" alt="slide-background">
		       						...
		       						<div class="row">
		       							<div class="col-sm-9 col-md-7 col-lg-6 offset-sm-3 offset-md-5 offset-lg-6">
		       								<div class="caption-txt">
					        					...
					        					<!-- Title -->
								         	 	<h2 class="steelblue-color">Enhancing your vision</h2>
												...
												<div class="box-list mb-15">	
													...
													<p class="p-md">Porta semper lacus cursus, feugiat primis ultrice in ligula risus 
													   auctor tempus feugiat dolor impedit magna
													</p>		
												</div>

												<!-- Button -->
												<a href="all-doctors.php" class="btn btn-blue blue-hover">Meet the Doctors</a>
						...
						<div class="col-lg-6">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor tempus feugiat
								   ...
								   metus mollis faucibus. An enim nullam tempor and sapien gravida donec pretium
								</p>
				...
				<div class="container">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title">		
							...
							<!-- Title 	-->	
							<h3 class="h3-md steelblue-color">Our Core Optometry Services</h3>	
			 		...
			 		<div class="row">
						...
						<div class="col-md-6 col-lg-3">
							<div class="sbox-4 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/eye_exam_700x700.jpg" alt="content-image" />	
									
								<!-- Text -->
								<div class="sbox-4-txt">
									<h5 class="h5-md steelblue-color"><a href="single-service.php">Eye Examination</a></h5>
						...
						<div class="col-md-6 col-lg-3">
							<div class="sbox-4 wow fadeInUp" data-wow-delay="0.6s">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/eye_correct_700x700.jpg" alt="content-image" />	
									
								<!-- Text -->
								<div class="sbox-4-txt">
									<h5 class="h5-md steelblue-color"><a href="single-service.php">Laser Eye Correction</a></h5>
									<p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
									   at pretium feugiat dolor integer
									</p>
								</div>								
						...
						<div class="col-md-6 col-lg-3">
							<div class="sbox-4 wow fadeInUp" data-wow-delay="0.8s">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/contact_lenses_700x700.jpg" alt="content-image" />	
									
								<!-- Text -->
								<div class="sbox-4-txt">
									<h5 class="h5-md steelblue-color"><a href="single-service.php">Contact Lenses</a></h5>
									<p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
									   at pretium feugiat dolor integer
									</p>
								</div>
						...
						<div class="col-md-6 col-lg-3">
							<div class="sbox-4 wow fadeInUp" data-wow-delay="1s">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/kids_eye_correct_700x700.jpg" alt="content-image" />	
									
								<!-- Text -->
								<div class="sbox-4-txt">
									<h5 class="h5-md steelblue-color"><a href="single-service.php">Kids Diagnostic</a></h5>
									<p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
									   at pretium feugiat dolor integer
									</p>
								</div>				
			...
			<!-- INFO-2
			============================================= -->
			<section id="info-2" class="bg-lightgrey wide-60 info-section division">
				<div class="container">
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-6">
							<div class="info-2-img wow fadeInUp" data-wow-delay="0.6s">
								<img class="img-fluid" src="images/image-13.png" alt="info-image">
							</div>
						</div>
							...
							<div class="doctor-1">								
								...
								<div class="hover-overlay text-center"> 
									...
									<div class="profile-link">
										<a class="btn btn-sm btn-tra-white black-hover" href="doctor-1.php" title="">View More Info</a>
									</div> 
								...
								<div class="doctor-meta">
									...
									<span class="blue-color">Lead Optometrist</span>
						...
						<div class="col-md-6 col-lg-3">
							<div class="doctor-1">	
								...
								<div class="hover-overlay text-center"> 
									...
									<!-- Profile Link -->		
									<div class="profile-link">
										<a class="btn btn-sm btn-tra-white black-hover" href="doctor-2.php" title="">View More Info</a>
									</div>
								...
								<div class="doctor-meta">
									...
									<span class="blue-color">Optometrist</span>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="all-doctors mb-40">
								<a href="all-doctors.php" class="btn btn-blue blue-hover">Meet All Doctors</a>
							</div>
						</div>
					</div>
			...
			<section id="info-9" class="bg-blue info-section division">
				...
				<!-- INFO-9 IMAGE -->
				<div class="info-9-img bg-fixed text-center" style="background-image: url(images/optometry-bg.jpg);"></div>
							...
							<div class="tab-content" id="pills-tabContent">
								...
								<div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab1-list">
									<div class="row d-flex align-items-center">
										...
										<div class="col-lg-6">
											<div class="tab-img">
												<img class="img-fluid" src="images/eye_exam_700x700.jpg" alt="tab-image" />
											</div>
										</div>
										...
										<div class="col-lg-6">
											<div class="txt-block pc-30">
												...
												<!-- Title -->
												<h3 class="h3-md steelblue-color">Eye Examination</h3>
								...
								<div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab2-list">
									<div class="row d-flex align-items-center">
										...
										<div class="col-lg-6">
											<div class="tab-imgs">
												<img class="img-fluid" src="images/eye_correct_700x700.jpg" alt="tab-image" />
											</div>
										</div>
										...
										<div class="col-lg-6">
											<div class="txt-block pc-30">
												...
												<!-- Title -->
												<h3 class="h3-md steelblue-color">Laser Eye Correction</h3>
												...
												<!-- Button -->
												<a href="service-2.php" class="btn btn-blue blue-hover mt-30">View More Details</a>
								...
								<div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab3-list">
									<div class="row d-flex align-items-center">
										...
										<div class="col-lg-6">
											<div class="tab-img">
												<img class="img-fluid" src="images/contact_lenses_700x700.jpg" alt="tab-image" />
											</div>
										</div>
										...
										<div class="col-lg-6">
											<div class="txt-block pc-30">
												...
												<!-- Title -->
												<h3 class="h3-md steelblue-color">Contact Lenses</h3>
								...
								<div class="tab-pane fade" id="tab-4" role="tabpanel" aria-labelledby="tab4-list">
									<div class="row d-flex align-items-center">
										...
										<div class="col-lg-6">
											<div class="tab-img">
												<img class="img-fluid" src="images/kids_eye_correct_700x700.jpg" alt="tab-image" />
											</div>
										</div>
										...
										<div class="col-lg-6">
											<div class="txt-block pc-30">
												...
												<!-- Title -->
												<h3 class="h3-md steelblue-color">Kids Diagnostic</h3>
				 		...
				 		<div class="col-lg-4">
				 			<div class="blog-post wow fadeInUp" data-wow-delay="0.4s">
								...
								<div class="blog-post-txt">
									...
									<!-- Post Title -->
									<h5 class="h5-sm steelblue-color"><a href="single-post.php">5 Benefits Of Integrative Medicine</a></h5>
				 		...
				 		<div class="col-lg-4">
				 			<div class="blog-post wow fadeInUp" data-wow-delay="0.6s">
								...
								<div class="blog-post-txt">
									...
									<!-- Post Title -->
									<h5 class="h5-sm steelblue-color"><a href="single-post.php">Your Health Is In Your Hands</a></h5>
				 		...
				 		<div class="col-lg-4">
				 			<div class="blog-post wow fadeInUp" data-wow-delay="0.8s">
								...
								<div class="blog-post-txt">
									...
									<!-- Post Title -->
									<h5 class="h5-sm steelblue-color"><a href="single-post.php">How Weather Impacts Your Health</a></h5>
						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-lg-6 offset-lg-1">
								<div class="banner-txt pc-30 wow fadeInUp" data-wow-delay="0.4s">
								    ...
								    <!-- Button -->
									<a href="all-doctors.php" class="btn btn-tra-white blue-hover">View Our Doctors</a>
