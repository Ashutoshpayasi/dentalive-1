		...
		<header id="header" class="header">
			...
			<div class="wsmainfull menu clearfix">
				<div class="wsmainwp clearfix">
					...
					<div class="desktoplogo"><a href="demo-1.php"><img src="images/logo.png" width="180" height="40" alt="header-logo"></a></div>
				...
				<div class="row">
						...
						<div class="posts-holder pr-30">
							...
							<div class="blog-post">
								...
								<div class="blog-post-txt">
									...
									<!-- Post Title -->
									<h5 class="h5-xl steelblue-color"><a href="single-post.php">5 Benefits Of Integrative Medicine</a></h5>
							...
							<div class="blog-post">
								...
								<div class="blog-post-txt">
									...
									<!-- Post Title -->
									<h5 class="h5-xl steelblue-color"><a href="single-post.php">How Weather Impacts Your Health</a></h5>
							...
							<div class="blog-post">
								...
								<div class="blog-post-txt">
									...
									<!-- Post Title -->
									<h5 class="h5-xl steelblue-color"><a href="single-post.php">Your Health Is In Your Hands</a></h5>
							...
							<div class="blog-post">
								...
								<div class="blog-post-txt">
									...
									<!-- Post Title -->
									<h5 class="h5-xl steelblue-color"><a href="single-post.php">20 Years of Caring. 15 Fact About MedService,
					...
					<aside id="sidebar" class="col-lg-4">
						...
						<div class="popular-posts sidebar-div mb-50">
							...
							<ul class="popular-posts">
								...
								<li class="clearfix d-flex align-items-center">
									...
									<!-- Text -->
									<div class="post-summary">
										<a href="single-post.php">Etiam sapien accumsan molestie ante empor ...</a>
										<p>43 Comments</p>
									</div>
								...
								<li class="clearfix d-flex align-items-center">
									...
									<!-- Text -->
									<div class="post-summary">
										<a href="single-post.php">Blandit tempor sapien ipsum, porta justo ...</a>
										<p>38 Comments</p>
									</div>
								...
								<li class="clearfix d-flex align-items-center">
									...
									<!-- Text -->
									<div class="post-summary">
										<a href="single-post.php">Cursus risus laoreet turpis auctor varius ...</a>
										<p>29 Comments</p>
									</div>
						...
						<div class="sidebar-timetable sidebar-div mb-50">
							...
							<!-- Button -->
							<a href="about.php" class="btn btn-blue blue-hover mt-10">View Timetable</a>
